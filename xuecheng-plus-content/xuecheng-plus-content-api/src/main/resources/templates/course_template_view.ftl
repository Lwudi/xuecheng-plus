        ...
        <div class="banner-left">
            ...
            <p class="tit">${model.courseBase.name}</p>
                ...
                <#if model.courseBase.charge=="201001">
                    <span class="new-pic">特惠价格￥${model.courseBase.originalPrice}</span>
                    <span class="old-pic">原价￥${model.courseBase.price}</span>
                <#elseif model.courseBase.charge=="201002">
            ...
            <div class="banner-rit">
                <p>
                  <a href="http://127.0.0.1/course/preview/learning.html?id=${model.courseBase.id}" target="_blank">
                    ...
                    <div class="article-left-box">
                        <div class="content">
                            ...
                            <#--<div class="item">
                                ...
                                <div class="drop-down" style="height: 260px;">
                                    <ul class="list-box">
                                        <li class="active"><a href="http://127.0.0.1/course/preview/learning.html?id=82&chapter=149" target=_blank>1.1 阅读：分级政策细节</a> <span>97’33”</span></li>
